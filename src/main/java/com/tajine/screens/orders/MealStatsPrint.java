...
public class MealStatsPrint {

	public void printRecipt(String printerName, Map<String, Integer> stats) throws JRException {

		try (InputStream in = getClass().getResourceAsStream("/stats.jrxml")){
			...
			JRBeanCollectionDataSource ordersSet = new JRBeanCollectionDataSource(stats.entrySet());
			parameters.put("STATS", ordersSet);
